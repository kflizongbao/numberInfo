...
namespace drawDong
{
    public partial class FormModel7 : Form
    {
        ...
        private ArrayList dLinesV = new ArrayList();
        ...
        public FormModel7(string p1, string p2, string p3)
        {
        ...
        private void FormModel7_Load(object sender, EventArgs e)
        {
            handleControl();
        ...
        private dLine getLine(int columnIndex, int rowIndex)
        {
            ...
            int arg0 = (rowIndex - (rowIndex > 0 ? 0 : 0)) * columnSize + columnIndex;
            dLine line = (dLine)dLinesDataOri[arg0];
            return line;
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            for(int i = 0; i < this.dataGridView2.Rows.Count;i++)
            {
                int v = Convert.ToInt32(Convert.ToDouble(i) / Convert.ToDouble(this.dataGridView2.Rows.Count) * 100);
                ...
                for (int j = 0; j < this.dataGridView2.ColumnCount; j++)
                {
                    ...
                    {
                        val = this.dataGridView2.Rows[i].Cells[j].Value.ToString().Trim();
                    }
                    ...
                    if (null != val && val.Length > 0)
                    {
                        for (int n = 0; n < i; n++)
                        {
                            string val1 = null;// this.dataGridView2.Rows[n].Cells[j].Value.ToString().Trim();
                            if (null != this.dataGridView2.Rows[n].Cells[j].Value)
                            {
                                val1 = this.dataGridView2.Rows[n].Cells[j].Value.ToString().Trim();
                            }
                            if (null == val1 || val1.Length <= 0)
                            {
                                this.dataGridView2.Rows[n].Cells[j].Value = val;
                                this.dataGridView2.Rows[i].Cells[j].Value = "";
                                break;
                            }
                        }
                    }
